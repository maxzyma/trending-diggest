...
> 需求队列（持续）。Triage → Refine → G1 DoD → ready → Delivery。

## Active

| Slug | Title | Status | Priority | Type | Updated |
|---|---|---|---|---|---|
...
| editorial-design-unification | 三站统一 editorial 设计系统（复用 theuntold 共享 token；门户/子站/github-trending） | collected | P1 | functional | 2026-07-09 |

## Archive（已交付/归档，计数：1）

| Slug | Title | Status | Updated |
|---|---|---|---|
| aggregation-portal | 聚合门户（单入口聚多源，3 仓交付；G1~G5 passed） | done | 2026-07-09 |
