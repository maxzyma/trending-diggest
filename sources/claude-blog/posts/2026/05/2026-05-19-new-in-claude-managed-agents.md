...
_英文标题：New in Claude Managed Agents: dreaming, outcomes, and multiagent orchestration_
...
_Build self-improving agents with dreaming_
...
_Handle complex tasks with multiple agents_
