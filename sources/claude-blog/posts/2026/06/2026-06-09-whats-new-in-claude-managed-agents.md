...
_英文标题：New in Claude Managed Agents: run agents on a schedule and store environment variables in vaults_
...
_Store environment variables in vaults to authenticate CLIs and other tools_
