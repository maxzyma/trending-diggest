...
1. Train a Goal GAN model using labelled goals from step 1 to produce new goals
2. Use these new goals to train the policy, improving its coverage objective.
...
1. Goal **coverage**: We should maximize the entropy of generated goals to encourage diverse goal and to improve the coverage over the goal space.
