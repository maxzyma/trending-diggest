...
1. Install OpenAI gym according to the [instruction](https://github.com/openai/gym#installation). For a minimal installation, run:
...
1. Finally clone the “playground” code and install the requirements.
