...
1. *Build it*: A BERT model is trained to classify toxic comments on the [Jigsaw dataset](https://lilianweng.github.io/posts/2021-03-21-lm-toxicity/#jigsaw).
...
1. The evaluation solely relies on Perspective API, so it cannot capture bias & toxicity attributes that are [not covered](https://lilianweng.github.io/posts/2021-03-21-lm-toxicity/#perspective-api-biases) by Perspective API, such as gender biases. Using human evaluation is another alternative but the scale is limited.
